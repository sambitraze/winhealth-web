...
const PriceBox = () => {
  return (
    <div className="absolute top-[0px] left-[720px] bg-paleturquoise-200 box-border w-[360px] flex flex-col items-center justify-center text-left text-sm text-gray-400 font-inter border-r-[1px] border-solid border-lavender">
      <PriceCard priceText="$25" subscriptionText="/Month" />
      <div className="self-stretch box-border h-20 flex flex-col py-5 px-0 items-center justify-center gap-[4px] border-b-[1px] border-solid border-dimgray-100">
        <div className="relative leading-[20px] font-medium">20 weeks</div>
      ...
      <div className="self-stretch box-border h-20 flex flex-col py-5 px-0 items-center justify-center border-b-[1px] border-solid border-dimgray-100">
        <div className="relative leading-[20px] font-medium">50 Pages</div>
      </div>
