    ...
    <Layout>
      <div className="container py-8">
        ...
        <p>
          ...
          related to it, still belong to Microheal Willness Private Limited.
        </p>{' '}
        <p>
          Microheal Willness Private Limited is committed to ensuring that the
        ...
        <p>
          The HealOGut app stores and processes personal data that you have
          ...
          phone&apos;s security features and it could mean that the HealOGut app
        ...
        <p>
          You should be aware that there are certain things that Microheal
          Willness Private Limited will not take responsibility for. Certain
          ...
          network provider, but Microheal Willness Private Limited cannot take
        ...
        <p>
          Along the same lines, Microheal Willness Private Limited cannot always
          ...
          you can&apos;t turn it on to avail the Service, Microheal Willness
          Private Limited cannot accept responsibility.
        </p>{' '}
        <p>
          With respect to Microheal Willness Private Limited&apos;s
          ...
          available to you. Microheal Willness Private Limited accepts no
        ...
        <p>
          ...
          download the updates if you want to keep using the app. Microheal
          Willness Private Limited does not promise that it will always update
        ...
        <p>These terms and conditions are effective as of 2023-10-04</p>{' '}
        <p>
