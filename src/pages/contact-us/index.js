...
const CanellationPolicy = () => {
  return (
    <Layout>
      <div className="container py-8">
        <h1>Cancellation & Refund Policy</h1>
        <p>Last updated on 26-11-2023 13:51:45</p>
        <p>
          MICROHEAL WELLNESS PRIVATE LIMITED believes in helping its customers as far as possible,
          ...
          the issue to them. In case of any Refunds approved by the MICROHEAL WELLNESS PRIVATE
          LIMITED, it’ll take 6-8 Days days for the refund to be processed to the end customer.</p>
      </div>
    </Layout>
  );
};

export default CanellationPolicy;
