    ...
    <Layout>
      <div className="container py-8"> <h1>Privacy Policy</h1>
        ...
        <ul>
          ...
          <li><strong>Application:</strong> HealOGut, the software program provided by the Company.</li>
          <li><strong>Company:</strong> Microheal Wellness Private Limited, SILVERSPRING BUNGLOWS, 21 LIVING BUNGLOW NO 18, Ahmedabad, 380060, Gujarat, India.</li>
          <li><strong>Country:</strong> Gujarat, India</li>
        ...
        <ul>
          ...
          <li>HeartRateRecord and StepsRecord on a daily basis to improve the treatment we provide and for overall analysis of user improvement.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>To provide You with news and offers:</strong> General information about other goods, services, and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</li>
        ...
        <ul>
          <li>By email: <a href="mailto:shashank@microheal.in">shashank@microheal.in</a></li>
          <li>By visiting this page on our website: <a href="https://microheal.in" target="_blank">https://microheal.in</a></li>
        </ul>
      </div>
    </Layout>
  );
