    ...
    <Layout>
      <div className="container py-8">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to HealOGut, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Microheal Wellness Private Limited,
              SILVERSPRING BUNGLOWS, 21 LIVING BUNGLOW NO 18, Ahemdabad, 380060,
              Gujurat, India.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: Shashank12winger@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:
              <a
                href="https://winhealth.care/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://winhealth.care/
              </a>
            </p>
          </li>
        </ul>
