...
const services = [
  {
    ...
    description:
      'Comprehensive care that addresses the interconnectedness of mental health and gut health for overall well-being.',
  },
  {
    id: 2,
    ...
    description:
      'A user-friendly dashboard to monitor and record symptoms of GI disorders for effective management.',
  },
  {
    id: 3,
    ...
    description:
      'Customized diet and exercise plans tailored to individual needs and health goals.',
  },
  {
    id: 4,
    ...
    description:
      'Access to a dedicated care manager round the clock for support and guidance.',
  },
  {
    id: 5,
    ...
    description:
      'Expert care focused on the diagnosis and treatment of gastrointestinal disorders.',
  },
  {
    id: 6,
    ...
    description:
      'Guidance and support to adopt healthy lifestyle changes for improved gut health and overall wellness.',
  },
];
  ...
  return (
    <div className="flex flex-col items-center p-4">
      ...
      <div className="mt-4 text-center font-proxima text-sm font-medium md:text-base">
        <p className="text-themeGrey">{condition.description}</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="bg-themeWhite">
      <div className="container py-4 md:py-10">
        <Title text="Services offered" className={'capitalize'} />
