...
const PricingSection = () => {
  return (
    <div className="container py-10">
      ...
      {/* Mobile */}
      <div className="flex flex-col gap-8 py-4 md:hidden">
        <div>
          <div className="flex flex-col justify-center border-b border-black bg-[#B6F4FF] px-4 py-3 text-center text-sm leading-4">
            <div>
              <span className="font-brandon text-3xl font-bold">Free</span>
              <span className="text-[#858BA0]">/ Lifetime</span>
            </div>
          ...
          <div className="flex flex-col items-center justify-center border-b border-black bg-[#B6F4FF] px-4 py-3 text-center text-sm leading-4">
            <div>2 weeks</div>
          </div>
          <div className="flex flex-col items-center justify-center border-b border-black bg-[#B6F4FF] px-4 py-3 text-center text-sm leading-4">
            <div>5 pages</div>
