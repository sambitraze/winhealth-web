      ...
      <div className="mx-auto max-w-screen-lg p-4 md:py-10">
        <div className="flex flex-col gap-4">
          <PatientsTestimonialCard
            ...
            testimonial={
              'MicroHeal has been a whole new level of care. I feel so much better equipped to handle my digestive issues and am back to living life uninterrupted by pain.”'
            }
            isImageToTheLeft={true}
          />
          <PatientsTestimonialCard
